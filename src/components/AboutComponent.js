            ...
            <div className="row vertical-content">
                <div className="col-lg-12">
                    <div className="features-box">
                        <h3>Who we are</h3>
                        <p className=" web-desc">yNet, Inc., is a company who provides innovative solutions to improve operational efficiencies for companies in providing a better life for consumers. Historically, there is a very large gap when a person passes, because it is dependent on the next of kin’s knowledge and experience with what steps must occur when a person passes.  IvyNet’s proprietary software solves this problem by closing that gap.</p>
